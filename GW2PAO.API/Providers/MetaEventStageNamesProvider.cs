    ...
    public class MetaEventStageNamesProvider : IStringProvider<Guid>
    {
        ...
        private void GenerateFiles()
        {
            ...
            List<MetaEventStageName> english = new List<MetaEventStageName>()
            {
                ...
                new MetaEventStageName() { ID = MetaEventStageID.LakeDoric_NoransHomestead,      Name = "Noran's Homestead" },
                new MetaEventStageName() { ID = MetaEventStageID.LakeDoric_SaidrasHaven,         Name = "Saidra's Haven" },
                new MetaEventStageName() { ID = MetaEventStageID.LakeDoric_NewLoamhurst,         Name = "New Loamhurst" },
                new MetaEventStageName() { ID = MetaEventStageID.CrystalOasis_CasinoBlitz,       Name = "Casino Blitz" },
                new MetaEventStageName() { ID = MetaEventStageID.DesertHighlands_BuriedTreasure, Name = "Buried Treasure" },
            ...
            List<MetaEventStageName> french = new List<MetaEventStageName>()
            {
                ...
                new MetaEventStageName() { ID = MetaEventStageID.DesertHighlands_BuriedTreasure, Name = "Trésor enfoui" },
                new MetaEventStageName() { ID = MetaEventStageID.DomainOfVabbi_SerpentsIre,      Name = "Serpents' Ire" },
                new MetaEventStageName() { ID = MetaEventStageID.DomainOfIstan_Palawadan,        Name = "Palawadan" },
